...
- 단점: 컬럼 값에 `INSERT`, `UPDATE`, `DELETE`가 발생할 때마다 인덱스를 정렬하기 때문에 **저장 속도가 느리다**  
...
- 인덱스의 키를 16bytes, 값에 해당하는 자식 노드 주소를 12bytes라 하면, 인덱스 페이지당 16*1024/28 = 585개의 키 저장 가능
